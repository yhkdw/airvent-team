...
const t = {
  ko: {
    ...
    footerLinks: { docs: "Medium", github: "GitHub", blog: "법인 홈페이지", privacy: "개인정보처리방침", terms: "이용약관", warranty: "보증정책" },
    toast: {
      welcome: "님, 환영합니다!",
      sub: "{tx.toast.sub}"
    },
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-10">
              <div>
                ...
                <ul className="space-y-2.5 text-sm text-slate-500">
                  ...
                  <li><a href="https://www.airventinc.co.kr" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors">{tx.footerLinks.blog}</a></li>
                </ul>
              </div>
              <div>
